    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background relative selection:bg-accent">
            ...
            <div className="w-full max-w-sm relative z-10 animate-fade-in-up">
                ...
                <h1 className="font-serif text-3xl md:text-4xl mb-2 tracking-tight">begin the ritual.</h1>
                <p className="text-foreground/60 mb-8 md:mb-10 font-light text-sm md:text-[15px]">Create an account to start your circle.</p>
