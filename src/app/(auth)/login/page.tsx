        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background relative selection:bg-accent">
            ...
            <div className="w-full max-w-sm relative z-10 animate-fade-in-up">
                ...
                <form className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                        <div className="flex justify-between items-baseline">
                            ...
                            <Link href="#" className="text-xs text-foreground/50 hover:text-foreground/80 font-medium">Reset</Link>
                        </div>
                        <input
                            type="password"
                            id="password"
                    ...
                    <Link href="/dashboard" className="block text-center w-full py-3.5 mt-4 bg-foreground text-background rounded-lg font-medium hover:bg-foreground/90 transition-all shadow-md hover:shadow-lg hover:-translate-y-[1px]">
                        Sign In
                    </Link>
                </form>
                ...
                <p className="mt-12 text-center text-sm text-foreground/50">
                    New here? <Link href="/signup" className="text-foreground font-medium underline-offset-4 hover:underline hover:text-foreground/80">Start a circle</Link>
                </p>
            </div>
        </div>
    );
